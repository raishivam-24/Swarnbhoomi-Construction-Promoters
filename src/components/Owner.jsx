  ...
  return (
    <section className="owners-section section" id="owners">
      ...
      <div className="owners-header">
        <span className="section-label">Meet the Directors</span>
        <div className="gold-rule" />
        <h2 className="owners-title serif">
          The Vision Behind<br /><em>Swarnbhoomi</em>
        </h2>
        <p className="owners-subtitle">
          Directly connect with our directors — no middlemen, no delays. Your project gets personal attention from day one.
        </p>
      </div>
      ...
      <div className="owner-single-wrap">
        ...
        <div className="owner-card-grand">
          ...
          <div className="ocg-info-side">
            ...
            <div className="ocg-contact-btns">
              ...
              <a href="https://wa.me/919926156896" target="_blank" rel="noopener noreferrer" className="ocg-btn ocg-wa">
        ...
        {/* Owner Card — Abhishek (Director) */}
        {/* TODO: confirm Abhishek's full name, phone number, and WhatsApp number below — placeholders are marked. */}
        <div className="owner-card-grand">
          ...
          <div className="ocg-photo-side">
            <div className="ocg-photo-frame">
              <img
                src="/image/owner/abhishek-director.png"
                alt="Abhishek — Director, Swarnbhoomi Construction"
              />
              <div className="ocg-photo-overlay" />
            </div>
            {/* Gold nameplate */}
            <div className="ocg-nameplate">
              <div className="ocg-name serif">Abhishek</div>
              <div className="ocg-role">Director</div>
              <div className="ocg-company">Swarnbhoomi Construction & Promoters</div>
            </div>
          </div>
          ...
          <div className="ocg-info-side">
            ...
            {/* Contact buttons — PLACEHOLDER phone numbers, replace with Abhishek's real numbers */}
            <div className="ocg-contact-btns">
              <a href="tel:+916005538340" className="ocg-btn ocg-call2">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.38 2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.77a16 16 0 0 0 6 6l.72-.88a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.27 16z"/>
                </svg>
                60055 38340
        ...
        <div className="appt-inner">
          ...
          <div className="appt-left">
            ...
            <p className="appt-subtitle">
              Tell us about your dream project. Our team will visit your site, assess requirements and give you a detailed plan — completely free.
            </p>
            ...
            <div className="appt-process">
              ...
              <div className="process-steps">
                {[
                  ...
                  ['3', 'Site Visit',      'Our team visits your plot'],
          ...
          <div className="appt-form-wrap">
            {submitted ? (
              <div className="appt-success">
                ...
                <p>Thank you <strong>{form.name}</strong>! Your construction consultation request has been sent to our team's WhatsApp. Expect a call at <strong>{form.phone}</strong> shortly.</p>
